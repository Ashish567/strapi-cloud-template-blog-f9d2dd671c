...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts for the learning platform';
    displayName: 'Blog';
    pluralName: 'blogs';
    singularName: 'blog';
  };
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Courses offered on the platform';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
  ...
  attributes: {
    ...
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    certificate: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage marketing content';
...
export interface ApiLearningPathLearningPath
  ...
  attributes: {
    color: Schema.Attribute.String;
    courses: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Individual lessons within a module';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['video', 'quiz', 'text']> &
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Modules/Chapters within a course';
    displayName: 'Module';
    pluralName: 'modules';
    singularName: 'module';
  };
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Hiring and ecosystem partners';
    displayName: 'Partner';
    pluralName: 'partners';
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Team profiles for About page';
